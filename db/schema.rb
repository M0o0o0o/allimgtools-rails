...
ActiveRecord::Schema[8.1].define(version: 2026_04_17_122916) do
  ...
  create_table "uploads", force: :cascade do |t|
    t.integer "chunks_received", default: 0, null: false
    t.datetime "created_at", null: false
    t.string "filename", null: false
    t.string "ip_address", null: false
    t.string "status", default: "pending", null: false
    ...
    t.index ["ip_address", "created_at"], name: "index_uploads_on_ip_address_and_created_at"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["subscription_id"], name: "index_users_on_subscription_id", unique: true
  end
